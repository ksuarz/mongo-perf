 ...
 *
 * @param {Boolean} isView - True if 'viewOrCollection' is a view; false if it is a collection.
...
function generateTestCase(options) {
    ...
    tests.push({
        ...
        post: options.post || function(view) {
            let collection = view.getDB().getCollection(view.getName() + "_backing");
            view.drop();
            collection.drop();
        },
        ops: [
...
generateTestCase({
    ...
    pre: function lookupPopulator(isView) {
        return function(ordersCollectionOrView) {
            ...
            var productsCollection = ordersCollectionOrView.getDB()[productCollName];
            var nDocs = 20;
...
generateTestCase({
    ...
    pre: function socialitePopulator(isView) {
        return function(userCollectionOrView) {
            ...
            var followerCollection = userCollectionOrView.getDB()[followerCollName];
...
generateTestCase({
    ...
    pre: function neighborPopulator(isView) {
        return function(sourceCollectionOrView) {
            ...
            var neighborCollection = sourceCollectionOrView.getDB()[neighborCollName];
            var sourceCollection;
